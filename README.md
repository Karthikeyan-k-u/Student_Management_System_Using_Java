...
* Repeat the following steps n times:
  - Read student details as a comma-separated string.
  - Split the string into name, department, year, and academic year.
  - Create a student object using the constructor.
  - Generate and display a student ID.
  - Display student details using class methods.
